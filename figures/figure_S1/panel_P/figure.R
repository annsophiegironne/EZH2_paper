...
# To see how enrichment scores were computed, see figures/figure_S1/panel_O/commands.sh
data <- read.csv("figures/figure_S1/panel_O/gene_id_enrichmentScores.csv", header=TRUE)
...
filename <- "figures/figure_S1/panel_P/figure_S1_P.pdf"
